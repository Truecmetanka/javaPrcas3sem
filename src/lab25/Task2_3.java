...
// Выбрать IPv4 адреса во всех возможных, представлениях: десятичном, шестнадцатеричном и
// восьмеричном, с точками и без. Подробнее про IP адреса можно узнать в википедии.